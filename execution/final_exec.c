...
/*   Updated: 2025/03/02 22:52:53 by amagoury         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 			// else if(is_bulidin(cmd) ==  false && execve(cmd->cmd_args[0],cmd->cmd_args,path->export_env) == -1) // replace path->path with a string array version of the values (environment variable) list.
// 					exit(1);
// 			exit(0);
// 		}
// 		else
